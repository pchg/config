...
if not exists? %word-cats.r [write %word-cats.r read http:re-bol.com/word-cats.r]
if not exists? %word-defs.r [write %word-defs.r read http:re-bol.com/word-defs.r]
