...
Messages.user_cert_missing = "fichier de certificat personnel non " \
    "trouvé"
Config.instname = "Université de Bordeaux"
Config.profilename = "EDUROAM_UBX_TTLS-PAP"
Config.url = "https://assistance.u-bordeaux.fr"
Config.email = "wifi@u-bordeaux.fr"
Config.title = "eduroam CAT"
Config.server_match = "radius.u-bordeaux.fr"
...
Config.init_confirmation = "Cet installateur ne fonctionnera " \
    "correctement que si vous êtes membre de {0} et du groupe utilisateur " \
    "{1}."
Config.user_realm = "u-bordeaux.fr"
Config.ssids = ['eduroam']
Config.del_ssids = []
Config.servers = ['DNS:radius.u-bordeaux.fr']
Config.use_other_tls_id = False
Config.anonymous_identity = "anonymous@u-bordeaux.fr"
Config.tou = ""
