...
sub renameFile($$){
  ...
  $newfile =~ s/\303\244/a/g;
  $newfile =~ s/\303\266/oe/g;
  $newfile =~ s/\303\274/ue/g;
  $newfile =~ s/\303\237/ss/g;
  
  #Frenck accents
  $newfile =~ s/\303\250/e/g;
  $newfile =~ s/\303\251/e/g;
  $newfile =~ s/\303\252/e/g;
  $newfile =~ s/\303\253/e/g;

  $newfile =~ s/\303\256/i/g;
  $newfile =~ s/\303\257/i/g;

  $newfile =~ s/\303\264/o/g;
  $newfile =~ s/\303\266/o/g;

  $newfile =~ s/\303\271/u/g;
  $newfile =~ s/\303\273/u/g;
  $newfile =~ s/\303\274/u/g;

  $newfile =~ s/\303\211/E/g;
  $newfile =~ s/\303\212/E/g;
  $newfile =~ s/\303\210/E/g;
  $newfile =~ s/\303\213/E/g;

  $newfile =~ s/\303\216/I/g;
  $newfile =~ s/\303\217/I/g;

  $newfile =~ s/\303\224/O/g;
  $newfile =~ s/\303\226/O/g;

  $newfile =~ s/\303\231/U/g;
  $newfile =~ s/\303\233/U/g;
  $newfile =~ s/\303\234/U/g;
