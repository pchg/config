...
all [
"All RED words"
{A complete list of all RED words.}
]
...
internal [
	"Internal RED functions."
	{These words are used internally by RED and you should
	avoid them if you can.

	Some of these words may become obsolete and could be removed or
	redefined in future versions of RED.}
]
