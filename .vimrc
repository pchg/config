...
map  <F11>      ?\<_______________ENCOURS_______________<cr> 
imap <F11> <Esc>?\<_______________ENCOURS_______________<cr>a
"mapper Shift-F11 avec la même chose, dans l'autre sens:
map  <S-F11>      /\<_______________ENCOURS_______________<cr> 
imap <S-F11> <Esc>/\<_______________ENCOURS_______________<cr>a
