...
function! s:MatchToggle()
  if exists('g:match_maps') && g:match_maps
    ...
    let g:match_maps = 1
   " Get rid of this boucle, pour déboguer:{
   "" for i in range(1, 9)
   ...
   "" endfor
   ""}
   	execute 'vnoremap <silent> <Leader>1 :<C-U>call <SID>DoHighlight(1, 1, v:count)<CR>'
    execute 'nnoremap <silent> <Leader>1 :<C-U>call <SID>DoHighlight(1, 2, v:count)<CR>'
    execute 'vnoremap <silent> <Leader>2 :<C-U>call <SID>DoHighlight(2, 1, v:count)<CR>'
    execute 'nnoremap <silent> <Leader>2 :<C-U>call <SID>DoHighlight(2, 2, v:count)<CR>'
    execute 'vnoremap <silent> <Leader>3 :<C-U>call <SID>DoHighlight(3, 1, v:count)<CR>'
    execute 'nnoremap <silent> <Leader>3 :<C-U>call <SID>DoHighlight(3, 2, v:count)<CR>'
    execute 'vnoremap <silent> <Leader>4 :<C-U>call <SID>DoHighlight(4, 1, v:count)<CR>'
    execute 'nnoremap <silent> <Leader>4 :<C-U>call <SID>DoHighlight(4, 2, v:count)<CR>'
    execute 'vnoremap <silent> <Leader>5 :<C-U>call <SID>DoHighlight(5, 1, v:count)<CR>'
    execute 'nnoremap <silent> <Leader>5 :<C-U>call <SID>DoHighlight(5, 2, v:count)<CR>'
    execute 'vnoremap <silent> <Leader>6 :<C-U>call <SID>DoHighlight(6, 1, v:count)<CR>'
    execute 'nnoremap <silent> <Leader>6 :<C-U>call <SID>DoHighlight(6, 2, v:count)<CR>'
    execute 'vnoremap <silent> <Leader>7 :<C-U>call <SID>DoHighlight(7, 1, v:count)<CR>'
    execute 'nnoremap <silent> <Leader>7 :<C-U>call <SID>DoHighlight(7, 2, v:count)<CR>'
    execute 'vnoremap <silent> <Leader>8 :<C-U>call <SID>DoHighlight(8, 1, v:count)<CR>'
    execute 'nnoremap <silent> <Leader>8 :<C-U>call <SID>DoHighlight(8, 2, v:count)<CR>'
    execute 'vnoremap <silent> <Leader>9 :<C-U>call <SID>DoHighlight(9, 1, v:count)<CR>'
    execute 'nnoremap <silent> <Leader>9 :<C-U>call <SID>DoHighlight(9, 2, v:count)<CR>'
    vnoremap <silent> <Leader>0 :<C-U>call <SID>UndoHighlight(1)<CR>
    nnoremap <silent> <Leader>0 :<C-U>call <SID>UndoHighlight(2)<CR>
    nnoremap <silent> <Leader><Minus> :call <SID>WindowMatches(0)<CR>
    nnoremap <silent> <Leader><Plus> :call <SID>WindowMatches(1)<CR>
    nnoremap <silent> <Leader><Multiply> :call <SID>WindowMatches(2)<CR>
...
"" 2020_12_06__11_39_33 
"" Ce plugin est si génial que je mets le mode de marquage dès le départ, par défaut, hop:
""call <SID>MatchToggle()
"" (non, trop caguant)
